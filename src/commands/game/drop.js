...
class UserCommand extends WynnCommand {
	...
	async messageRun(message, args) {
		...
		const checkCoolDown = await this.container.client.checkTimeCoolDown(message.author.id, this.name, coolDown.game.drop, t);
		if (checkCoolDown) {
	...
	async execute(interaction) {
		...
		const checkCoolDown = await this.container.client.checkTimeCoolDown(interaction.user.id, this.name, coolDown.game.drop, t);
		if (checkCoolDown) {
